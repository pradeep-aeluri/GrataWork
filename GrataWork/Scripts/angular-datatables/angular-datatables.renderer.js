...
angular.module('datatables.renderer', ['datatables.instances', 'datatables.factory', 'datatables.options', 'datatables.instances'])
    .factory('DTRendererService', ['DTLoadingTemplate', dtRendererService])
    .factory('DTRenderer', dtRenderer)
    .factory('DTDefaultRenderer', ['$q','DTRenderer', 'DTRendererService', 'DTInstanceFactory', dtDefaultRenderer])
    .factory('DTNGRenderer', ['$log', '$q', '$compile', '$timeout', 'DTRenderer', 'DTRendererService', 'DTInstanceFactory', dtNGRenderer])
    .factory('DTPromiseRenderer', ['$q', '$timeout', '$log', 'DTRenderer', 'DTRendererService', 'DTInstanceFactory', dtPromiseRenderer])
    .factory('DTAjaxRenderer', ['$q', '$timeout', 'DTRenderer', 'DTRendererService', 'DT_DEFAULT_OPTIONS', 'DTInstanceFactory', dtAjaxRenderer])
    .factory('DTRendererFactory', ['DTDefaultRenderer', 'DTNGRenderer', 'DTPromiseRenderer', 'DTAjaxRenderer', dtRendererFactory]);
